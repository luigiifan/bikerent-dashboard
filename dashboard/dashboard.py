...
st.sidebar.markdown("Dibuat oleh :blue[Luigi Ifan]")
...
st.markdown(
    f"""
    <div style="background-color: #1AA7EC; padding: 20px; border-radius: 10px;">
        <h4 style="color: #FFFFFF;">Total Penyewaan Berdasarkan Cuaca:</h4>
